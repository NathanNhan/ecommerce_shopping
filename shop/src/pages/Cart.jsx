...
import { deleteCart } from "../cartRedux/apiCall";

import { removeAllCart, increase, decrease, getTotal } from "../cartRedux/cartRedux";
          ...
          <Summary>
            ...
            >
              {userInfo ? (
                ...
                <Button>
                  <Link to="/login" style={{ textDecoration: "none" , color : "white" }}>LOGIN TO CHECKOUT</Link>
                </Button>
              )}
            </StripeCheckout>
          </Summary>
